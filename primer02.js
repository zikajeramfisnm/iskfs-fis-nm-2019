...
http.createServer(function(req, res){ // http.createServer([requestListener])
    ...
    if (operator == 4) {
        console.log("Izključevanje LED1 in LED2");
        board.digitalWrite(8, board.LOW);
        board.digitalWrite(13, board.LOW);
    }      
    if (operator == 5) {
        console.log("Vključevanje LED1 in LED2");
        board.digitalWrite(8, board.HIGH);
        board.digitalWrite(13, board.HIGH);
    }      
        
    res.writeHead(200, {"Content-Type": "text/html; charset=utf-8"});
    res.write("Za test vpišite v brskalnikovo vrstico z naslovom: http://192.168.1.203:8080/1 <br>");
    res.write("ali: http://192.168.1.203:8080/0<br>");
